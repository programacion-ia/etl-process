...
if __name__=="__main__":
    ...
    data_dir = Path.cwd() / config['data_dir']
    ...
    for name, (url, file_format) in api_urls.items():
        ...
        if file_format == "zip":
            ...
            for extracted_file in extracted_files:
                if extracted_file.is_file() and extracted_file.name != f"{name}.zip":
                    extracted_file.rename(data_dir / f"{name}{extracted_file.suffix}")
